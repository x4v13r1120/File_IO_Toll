...
public class vehicle {
    public static double calculatedGasCost(int number_Of_Axel,double base_rate) {
    ...
    public static void Sample_numbers_for_vehicle_Questions(List car_Types, List payment_methods){
